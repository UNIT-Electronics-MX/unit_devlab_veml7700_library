/*!
 *  @file DevLab_VEML7700.cpp
 *
 *  @mainpage DevLab VEML7700 I2C Lux Sensor
 *
 ...
 */
DevLab_VEML7700::DevLab_VEML7700(void) {}
 ...
 */
bool DevLab_VEML7700::begin(TwoWire *theWire) {
 ...
 */
float DevLab_VEML7700::readLux(luxMethod method) {
  bool wait = true;
  switch (method) {
 ...
 */
uint16_t DevLab_VEML7700::readALS(bool wait) {
  if (wait)
    readWait();
  lastRead = millis();
 ...
 */
uint16_t DevLab_VEML7700::readWhite(bool wait) {
  if (wait)
    readWait();
  lastRead = millis();
 ...
 */
void DevLab_VEML7700::enable(bool enable) {
 ...
 */
bool DevLab_VEML7700::enabled(void) { return !ALS_Shutdown->read(); }

/*!
 *    @brief Enable or disable the interrupt
 *    @param enable The flag to enable/disable
 */
void DevLab_VEML7700::interruptEnable(bool enable) {
 ...
 *    @returns True if enabled, false otherwise
 */
bool DevLab_VEML7700::interruptEnabled(void) {
 ...
 */
void DevLab_VEML7700::setPersistence(uint8_t pers) {
 ...
 *    VEML7700_PERS_4 or VEML7700_PERS_8
 */
uint8_t DevLab_VEML7700::getPersistence(void) {
 ...
 */
void DevLab_VEML7700::setIntegrationTime(uint8_t it, bool wait) {
 ...
 */
uint8_t DevLab_VEML7700::getIntegrationTime(void) {
 ...
 */
int DevLab_VEML7700::getIntegrationTimeValue(void) {
 ...
 * VEML7700_GAIN_1_4
 */
void DevLab_VEML7700::setGain(uint8_t gain) {
  ALS_Gain->write(gain);
 ...
 */
uint8_t DevLab_VEML7700::getGain(void) { return ALS_Gain->read(); }

/*!
 *    @brief Get ALS gain value
 *    @returns Actual gain value as float
 */
float DevLab_VEML7700::getGainValue(void) {
  switch (getGain()) {
 ...
 */
void DevLab_VEML7700::powerSaveEnable(bool enable) {
 ...
 */
bool DevLab_VEML7700::powerSaveEnabled(void) {
 ...
 */
void DevLab_VEML7700::setPowerSaveMode(uint8_t mode) {
 ...
 */
uint8_t DevLab_VEML7700::getPowerSaveMode(void) {
 ...
 */
void DevLab_VEML7700::setLowThreshold(uint16_t value) {
 ...
 */
uint16_t DevLab_VEML7700::getLowThreshold(void) {
 ...
 */
void DevLab_VEML7700::setHighThreshold(uint16_t value) {
 ...
 */
uint16_t DevLab_VEML7700::getHighThreshold(void) {
 ...
 */
uint16_t DevLab_VEML7700::interruptStatus(void) {
 ...
 * settings.
 */
float DevLab_VEML7700::getResolution(void) {
 ...
 *    @return lux value
 */
float DevLab_VEML7700::computeLux(uint16_t rawALS, bool corrected) {
...
void DevLab_VEML7700::readWait(void) {
  // From app note:
  //   '''
 ...
 */
float DevLab_VEML7700::autoLux(void) {
